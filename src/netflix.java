            ...
            case 2:
                ...
                switch (descripcion1){
                    ...
                    case 4:
                        ...
                        System.out.println("Un clásico del terror psicológico que sigue la historia de Norman Bates y su " +
                                "perturbadora relación con su madre en un motel aislado.");
                        break;
                    case 5:
                        System.out.println("The Exorcist");
                        System.out.println("año:1973");
                        System.out.println("director:William Friedkin");
                        System.out.println("Basada en la novela de William Peter Blatty, esta película es conocida por su " +
                                "intensidad y la historia de posesión demoníaca de una niña de 12 años.");
                        break;
                    case 6:
                    ...
                    case 7:
                        ...
                        System.out.println("Adaptación de la novela de Stephen King, esta película sigue la historia de " +
                                "un hombre que gradualmente se vuelve loco mientras trabaja como cuidador de un hotel " +
                                "aislado en invierno.");
                        break;
                    case 8:
                        ...
                        System.out.println("Introduce a Freddy Krueger, un asesino de niños que atormenta a adolescentes " +
                                "en sus sueños, causándoles la muerte en la vida real.");
                        break;
                    case 9:
            ...
            case 5:
                ...
                switch (descripcion4){
                    case 1:
                        ...
                        System.out.println("Un banquero es condenado injustamente por el asesinato de su esposa y pasa décadas en la prisión de Shawshank, donde desarrolla una amistad única con un compañero interno mientras planea su escape.");
                        break;
                    case 2:
                        System.out.println("Schindler's List");
                        System.out.println("año:1993");
                        System.out.println("director:Steven Spielberg");
                        System.out.println("Basada en hechos reales, la película sigue a Oskar Schindler, un empresario alemán que salva a más de mil judíos durante el Holocausto al emplearlos en sus fábricas.");
                        break;
                    case 3:
                        System.out.println("Forrest Gump");
                        System.out.println("año:1994");
                        System.out.println("director: Robert Zemeckis");
                        System.out.println("Forrest Gump, un hombre con una capacidad mental limitada pero un corazón puro, vive una vida extraordinaria, influyendo sin saberlo en varios eventos históricos clave del siglo XX en Estados Unidos.");
                        break;
                    case 4:
                        System.out.println("The Godfather ");
                        System.out.println("año:1972");
                        System.out.println("director:Francis Ford Coppola");
                        System.out.println("Una saga épica sobre la familia criminal Corleone, centrada en el ascenso al poder de Don Vito Corleone y los conflictos que enfrenta con otras familias criminales.");
                        break;
                    case 5:
                        System.out.println("Life is Beautiful (La vita è bella)");
                        System.out.println("año:1997");
                        System.out.println("director:Roberto Benigni");
                        System.out.println("En la Italia fascista, un padre judío utiliza su ingenio y humor para proteger a su hijo pequeño en un campo de concentración nazi, haciéndole creer que están participando en un juego.");
                        break;
                    case 6:
                        System.out.println("The Green Mile ");
                        System.out.println("año:1999");
                        System.out.println("director:John McTiernan");
                        System.out.println("Basada en una novela de Stephen King, la película narra la historia de un guardia de prisiones que presencia eventos milagrosos y sobrenaturales con un preso condenado a muerte.");
                        break;
                    case 7:
                        System.out.println("A Beautiful Mind");
                        System.out.println("año:2001");
                        System.out.println("director:Ron Howard");
                        System.out.println("Basada en la vida real de John Nash, un brillante matemático que lucha con la esquizofrenia mientras hace importantes descubrimientos en el campo de la teoría de juegos.");
                        break;
                    case 8:
                        System.out.println("Good Will Hunting");
                        System.out.println("año:1997");
                        System.out.println("director:Gus Van Sant");
                        System.out.println("Un genio matemático autodidacta, pero problemático, encuentra la dirección en su vida con la ayuda de un terapeuta y una relación con una chica de Boston.");
                        break;
                    case 9:
                        System.out.println("The Pianist");
                        System.out.println("año:2002");
                        System.out.println("director: Roman Polanski");
                        System.out.println("Basada en las memorias de Władysław Szpilman, un pianista judío polaco que sobrevive al Holocausto en Varsovia, ocultándose y enfrentando terribles adversidades.");
                        break;
                    case 10:
                        System.out.println("Dallas Buyers Club");
                        System.out.println("año:2013");
                        System.out.println("director: Jean-Marc Vallée");
                        System.out.println("Basada en hechos reales, la película sigue a Ron Woodroof, un electricista homofóbico diagnosticado con VIH/SIDA en los años 80, quien comienza a contrabandear medicamentos no aprobados para él y otros pacientes.");
                        break;
                    default:
                        System.out.println("recuerda escoger uno");
                }
            ...
            case 6:
                ...
                switch (descripcion5){
                    case 1:
                        ...
                        System.out.println("Basada en la novela de J.R.R. Tolkien, la película sigue a Frodo Baggins y un grupo de compañeros mientras se embarcan en una peligrosa misión para destruir un poderoso anillo y salvar a la Tierra Media de la oscuridad.");
                        break;
                    case 2:
                        System.out.println("Pan's Labyrinth (El laberinto del fauno)");
                        System.out.println("año:2006");
                        System.out.println("director:Guillermo del Toro");
                        System.out.println("En la posguerra de España, una niña descubre un laberinto mágico donde se encuentra con criaturas fantásticas que le revelan su verdadero destino.");
                        break;
                    case 3:
                        System.out.println("Harry Potter and the Philosopher's Stone");
                        System.out.println("año:2001");
                        System.out.println("director:Chris Columbus");
                        System.out.println("La primera película de la serie basada en los libros de J.K. Rowling, sigue a un joven mago, Harry Potter, mientras descubre su herencia mágica y enfrenta al malvado Lord Voldemort.");
                        break;
                    case 4:
                        System.out.println("Spirited Away (Sen to Chihiro no Kamikakushi) ");
                        System.out.println("año:2001");
                        System.out.println("director: Hayao Miyazaki");
                        System.out.println("Una niña llamada Chihiro se adentra en un mundo mágico habitado por dioses y espíritus, donde debe trabajar en un baño público para salvar a sus padres transformados en cerdos.");
                        break;
                    case 5:
                        ...
                        System.out.println("Basada en la novela de C.S. Lewis, la película cuenta la historia de cuatro hermanos que descubren un mundo mágico llamado Narnia, donde se unen al león Aslan para derrotar a la Bruja Blanca y restaurar la paz.");
                        break;
                    case 6:
                        System.out.println("The Wizard of Oz");
                        System.out.println("año:1939");
                        System.out.println("director:Victor Fleming");
                        System.out.println("Una joven llamada Dorothy es llevada por un tornado a la tierra de Oz, donde busca al Mago de Oz para ayudarla a regresar a casa mientras hace nuevos amigos en el camino.");
                        break;
                    case 7:
                        System.out.println("Avatar ");
                        System.out.println("año:2009");
                        System.out.println("director:James Cameron");
                        System.out.println("En el planeta Pandora, un ex marine se une a los Na'vi, la raza indígena, en una lucha contra los humanos que intentan explotar los recursos del planeta, explorando temas de ecología y conservación.");
                        break;
                    case 8:
                        System.out.println("The Shape of Water");
                        System.out.println("año:2017");
                        System.out.println("director:Guillermo del Toro");
                        System.out.println("En la Guerra Fría, una limpiadora muda trabaja en un laboratorio gubernamental y desarrolla una relación especial con una criatura anfibia cautiva, enfrentándose a la hostilidad y la intolerancia.");
                        break;
                    case 9:
                        System.out.println("Pirates of the Caribbean: The Curse of the Black Pearl");
                        System.out.println("año:2003");
                        System.out.println("director:Gore Verbinski");
                        System.out.println("El capitán Jack Sparrow se embarca en una aventura para recuperar su barco, enfrentándose a un pirata maldito y a una tripulación sedienta de sangre en esta saga de aventuras y fantasía.");
                        break;
                    case 10:
                        System.out.println("The Dark Crystal");
                        System.out.println("año:1982");
                        System.out.println("director:Jim Henson, Frank Oz");
                        System.out.println("En un mundo fantástico habitado por criaturas místicas, un joven llamado Jen debe restaurar el cristal oscuro para salvar a su mundo del dominio del malvado Skeksis.");
                        break;
                    default:
                        System.out.println("recuerda escoger uno");
                }
            ...
            case 7:
                ...
                switch (descripcion6){
                    case 1:
                        ...
                        System.out.println("Basada en la novela de Nicholas Sparks, la película cuenta la historia de amor entre Noah y Allie, que se enfrentan a obstáculos sociales y personales a lo largo de los años.");
                        break;
                    case 2:
                        System.out.println("Titanic");
                        System.out.println("año:1997");
                        System.out.println("director: James Cameron");
                        System.out.println("Una joven aristócrata y un artista bohemio se enamoran a bordo del Titanic, enfrentándose al desastre del famoso naufragio que cambiará sus vidas para siempre.");
                        break;
                    case 3:
                        System.out.println("La La Land");
                        System.out.println("año:2016");
                        System.out.println("director:Damien Chazelle");
                        System.out.println("En Los Ángeles, un pianista de jazz y una aspirante a actriz se enamoran mientras persiguen sus sueños en una ciudad conocida por destruir esperanzas y romances.");
                        break;
                    case 4:
                        System.out.println("Before Sunrise");
                        System.out.println("año:1995");
                        System.out.println("Richard Linklater");
                        System.out.println("Dos extraños se encuentran en un tren europeo y deciden pasar una noche juntos en Viena, explorando la conexión humana y el romance efímero.");
                        break;
                    case 5:
                        System.out.println("500 Days of Summer");
                        System.out.println("año:2009");
                        System.out.println("director:Marc Webb");
                        System.out.println("La película narra la relación de Tom y Summer, explorando las expectativas y realidades del amor moderno a través de una estructura no lineal.");
                        break;
                    case 6:
                        System.out.println("Pride and Prejudice");
                        System.out.println("año:2005");
                        System.out.println("director:Joe Wright");
                        System.out.println("Basada en la novela de Jane Austen, la película sigue la complicada relación entre Elizabeth Bennet y Mr. Darcy en la Inglaterra del siglo XIX.");
                        break;
                    case 7:
                        System.out.println("Eternal Sunshine of the Spotless Mind");
                        System.out.println("año:2004");
                        System.out.println("director:Michel Gondry");
                        System.out.println("Después de una ruptura dolorosa, Joel decide borrar todos los recuerdos de su ex novia Clementine, pero pronto descubre que algunos recuerdos y sentimientos son imposibles de borrar por completo.");
                        break;
                    case 8:
                        System.out.println("The Fault in Our Stars");
                        System.out.println("año:2014");
                        System.out.println("director: Josh Boone");
                        System.out.println("Basada en la novela de John Green, la película sigue la historia de amor entre dos adolescentes con cáncer que se conocen en un grupo de apoyo y emprenden un viaje para encontrar respuestas sobre el amor y la vida.");
                        break;
                    case 9:
                        System.out.println("Notting Hill ");
                        System.out.println("año:1999");
                        System.out.println("director:Roger Michell");
                        System.out.println("Un famoso actor se enamora de una librera común en el colorido barrio de Notting Hill en Londres, enfrentándose a las diferencias sociales y los desafíos de la fama.");
                        break;
                    case 10:
                        System.out.println("The Princess Bride");
                        System.out.println("año:1987");
                        System.out.println("director:Rob Reiner");
                        System.out.println("Una mezcla de romance, comedia y aventura, la película cuenta la historia de amor entre Buttercup y Westley, ambientada en un mundo de princesas, piratas y duelos a muerte.");
                        break;
                    default:
                        System.out.println("recuerda escoger uno");
                }
            ...
            case 8:
                ...
                switch (descripcion7){
                    case 1:
                        ...
                        System.out.println("año:2003");
                        System.out.println("director:Gore Verbinski");
                        System.out.println("Un capitán pirata extravagante, Jack Sparrow, se une a un joven herrero y a una gobernadora para salvar a su hija de una tripulación maldita y su capitán undead.");
                        break;
                    case 2:
                        System.out.println("Indiana Jones: En busca del arca perdida");
                        System.out.println("año:1981");
                        System.out.println("director:Steven Spielberg");
                        System.out.println("El arqueólogo Indiana Jones se embarca en una aventura peligrosa para encontrar el Arca de la Alianza antes que los nazis.");
                        break;
                    case 3:
                        System.out.println("El Señor de los Anillos: La Comunidad del Anillo");
                        System.out.println("año:2001");
                        System.out.println("director:Peter Jackson");
                        System.out.println(" Frodo Baggins y un grupo de compañeros emprenden un viaje para destruir un anillo mágico y evitar que caiga en manos del malvado Sauron.");
                        break;
                    case 4:
                        System.out.println("Mad Max:Jurassic Park");
                        System.out.println("año:1993");
                        System.out.println("director: Steven Spielberg");
                        System.out.println("Un multimillonario crea un parque temático de dinosaurios reales, pero las cosas salen mal cuando los dinosaurios escapan y ponen en peligro a los visitantes.");
                        break;
                    case 5:
                        System.out.println("Los Goonies");
                        System.out.println("año:1985");
                        System.out.println("director:Richard Donner");
                        System.out.println("Un grupo de jóvenes amigos descubre un mapa del tesoro y se embarca en una emocionante aventura para encontrar un tesoro escondido y salvar sus hogares.\n");
                        break;
                    case 6:
                        System.out.println("La vida secreta de Walter Mitty ");
                        System.out.println("año:2013");
                        System.out.println("director:Ben Stiller");
                        System.out.println("Un empleado de una revista que vive en un mundo de fantasía se embarca en una búsqueda global para encontrar un fotógrafo y recuperar una imagen perdida.");
                        break;
                    case 7:
                        System.out.println("La búsqueda");
                        System.out.println("año:2004");
                        System.out.println("director: Jon Turteltaub");
                        System.out.println("Un historiador busca un tesoro legendario con la ayuda de pistas dejadas por los Padres Fundadores de los Estados Unidos, enfrentándose a peligros y enigmas.");
                        break;
                    case 8:
                        System.out.println("Up: Una aventura de altura");
                        System.out.println("año:2009");
                        System.out.println("director:Pete Docter, Bob Peterson");
                        System.out.println(" Un anciano y un joven explorador vuelan en una casa suspendida por globos hacia las cataratas de Venezuela, enfrentando desafíos y descubriendo la importancia del amor y la aventura.");
                        break;
                    case 9:
                        System.out.println("El libro de la selva");
                        System.out.println("año:2016");
                        System.out.println("director:Jon Favreau");
                        System.out.println(" Un niño criado por lobos se embarca en un viaje por la selva con la ayuda de una pantera y un oso, mientras es perseguido por un tigre vengativo.");
                        break;
                    case 10:
                        System.out.println("El hobbit: Un viaje inesperado");
                        System.out.println("año:2012");
                        System.out.println("director:Peter Jackson");
                        System.out.println("Bilbo Bolsón, un hobbit pacífico, se une a un grupo de enanos y al mago Gandalf en una búsqueda para recuperar el reino perdido de Erebor del dragón Smaug.");
                        break;
                    default:
                        System.out.println("recuerda escoger uno");
                }
            ...
            case 9:
                ...
                switch (descripcion8){
                    case 1:
                        ...
                        System.out.println("año:1991");
                        System.out.println("director:Jonathan Demme");
                        System.out.println("Una agente del FBI busca la ayuda de un brillante pero peligroso psicópata encarcelado para atrapar a otro asesino en serie que está aterrorizando a mujeres.");
                        break;
                    case 2:
                        System.out.println("Psicosis");
                        System.out.println("año:1960");
                        System.out.println("director:Alfred Hitchcock");
                        System.out.println("Una secretaria en fuga se encuentra en un motel aislado dirigido por un joven con problemas y su dominante madre, desencadenando eventos siniestros.");
                        break;
                    case 3:
                        System.out.println("Seven");
                        System.out.println("año:1995");
                        System.out.println("director:David Fincher");
                        System.out.println("Dos detectives investigan una serie de asesinatos inspirados en los siete pecados capitales, mientras el asesino los desafía con su retorcida visión del castigo.");
                        break;
                    case 4:
                        System.out.println("El sexto sentido");
                        System.out.println("año:1999");
                        System.out.println("director:M. Night Shyamalan");
                        System.out.println("Un psicólogo infantil intenta ayudar a un niño que dice ver personas muertas, desentrañando secretos sorprendentes mientras lidia con sus propios problemas.");
                        break;
                    case 5:
                        System.out.println("Prisioneros");
                        System.out.println("año:2013");
                        System.out.println("director:Denis Villeneuve");
                        System.out.println("Después de la desaparición de sus hijas, un carpintero y un detective desesperado se adentran en un oscuro laberinto de secretos y venganza.");
                        break;
                    case 6:
                        System.out.println("La ventana indiscreta ");
                        System.out.println("año:1954");
                        System.out.println("director: Alfred Hitchcock");
                        System.out.println("Un fotógrafo confinado a una silla de ruedas sospecha que uno de sus vecinos ha cometido un crimen, desencadenando una serie de eventos de suspense.");
                        break;
                    case 7:
                        System.out.println("El club de la pelea");
                        System.out.println("año:1999");
                        System.out.println("director: David Fincher");
                        System.out.println("Un hombre insomne y un carismático vendedor de jabón forman un club de lucha clandestino que se convierte en algo mucho más siniestro.");
                        break;
                    case 8:
                        System.out.println("Memento");
                        System.out.println("año:2000");
                        System.out.println("director:Christopher Nolan");
                        System.out.println("Un hombre con amnesia anterógrada utiliza fotos polares y tatuajes para rastrear al asesino de su esposa, enfrentándose a giros y traiciones inesperados.");
                        break;
                    case 9:
                        System.out.println("Cisne negro ");
                        System.out.println("año:2010");
                        System.out.println("director:Darren Aronofsky");
                        System.out.println("Una bailarina obsesionada con el perfeccionismo se ve inmersa en un juego psicológico que la lleva al borde de la locura durante la preparación para un gran papel.");
                        break;
                    case 10:
                        System.out.println("El juego");
                        System.out.println("año:1997");
                        System.out.println("director: David Fincher");
                        System.out.println("Un hombre recibe un regalo extraño que lo introduce en un juego enigmático y peligroso que parece controlar cada aspecto de su vida.");
                        break;
                    default:
                        System.out.println("recuerda escoger uno");
                }
            ...
            case 10:
                ...
                switch (descripcion9){
                    case 1:
                        ...
                        System.out.println("director:Stanley Kubrick");
                        System.out.println("Un astronauta y la inteligencia artificial HAL 9000 investigan un monolito alienígena que podría redefinir el origen y el destino de la humanidad.");
                        break;
                    case 2:
                        System.out.println("Blade Runner");
                        System.out.println("año:1982");
                        System.out.println("director:Ridley Scott");
                        System.out.println("En un futuro distópico, un ex policía debe cazar replicantes, androides casi indistinguibles de los humanos, en los sórdidos callejones de Los Ángeles.");
                        break;
                    case 3:
                        System.out.println("Matrix ");
                        System.out.println("año:1999");
                        System.out.println("director:Hermanos Wachowski (Lilly y Lana Wachowski)");
                        System.out.println("Un hacker descubre que la realidad en la que vive es una simulación controlada por máquinas inteligentes, y se une a la resistencia para liberar a la humanidad.");
                        break;
                    case 4:
                        System.out.println("Jurassic Park");
                        System.out.println("año:1993");
                        System.out.println("director: Steven Spielberg");
                        System.out.println("Un excéntrico multimillonario crea un parque de atracciones con dinosaurios clonados, pero las cosas salen mal cuando los animales escapan y ponen en peligro a los visitantes.");
                        break;
                    case 5:
                        ...
                        System.out.println("En un universo de guerras galácticas, un granjero y un contrabandista se unen a la princesa Leia para luchar contra el malvado Imperio Galáctico y su temible Estrella de la Muerte.");
                        break;
                    case 6:
                        System.out.println("Alien, el octavo pasajero");
                        System.out.println("año:1979");
                        System.out.println("director:Ridley Scott");
                        System.out.println("La tripulación de una nave espacial comercial descubre una forma de vida alienígena letal que los acecha en los confines del espacio, desatando terror y supervivencia.");
                        break;
                    case 7:
                        System.out.println("Interestelar");
                        System.out.println("año:2014");
                        System.out.println("director:Christopher Nolan");
                        System.out.println("En un futuro donde la Tierra se enfrenta a una crisis ambiental, un grupo de exploradores emprende un viaje interestelar para encontrar un nuevo hogar para la humanidad.");
                        break;
                    case 8:
                        System.out.println("The Matrix");
                        System.out.println("año:2014");
                        System.out.println("director:Alex Garland");
                        System.out.println("Un joven programador es seleccionado para participar en un experimento de inteligencia artificial con una robot humanoide de apariencia femenina, que desafía las percepciones de lo que significa ser consciente.");
                        break;
                    case 9:
                        System.out.println("Terminator 2: El Juicio Final");
                        System.out.println("año:1991");
                        System.out.println("director:James Cameron");
                        System.out.println("Un ciborg del futuro es enviado al pasado para proteger a un niño destinado a salvar a la humanidad de un apocalipsis liderado por máquinas inteligentes, mientras otro ciborg intenta eliminarlo.");
                        break;
                    case 10:
                        System.out.println("Gravity");
                        System.out.println("año:2013");
                        System.out.println("director:Alfonso Cuarón");
                        System.out.println("Dos astronautas quedan varados en el espacio después de un accidente catastrófico, luchando por sobrevivir mientras intentan regresar a la Tierra.");
                        break;
